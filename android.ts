...
export class Android extends PlatformDirsABC {
    override get userDataDir(): string {
      return this._appendAppNameAndVersion(_androidFolder()!, "files");
    }
    ...
    override get userConfigDir(): string {
      return this._appendAppNameAndVersion(_androidFolder()!, "shared_prefs");
    }
    ...
    override get userCacheDir(): string {
      return this._appendAppNameAndVersion(_androidFolder()!, "cache");
    }
